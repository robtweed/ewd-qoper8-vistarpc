...
function runRPC(params, session) {
  ...
  var context = session.data.$('VistA').$('context')._value;
  if (!context || context === '') {
  ...
  if (status.result === 'ERROR') {
    ...
    var results = resultsNode._getDocument(true);
